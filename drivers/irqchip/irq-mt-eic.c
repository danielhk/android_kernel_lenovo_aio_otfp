...
/*lenovo-sw,lily8,2015-5-22,for piezo EINT debounce setting begin*/
#ifdef CONFIG_LENOVO_PIEZO
unsigned int special_eint_pin[1] = {46};
#endif
/*lenovo-sw,lily8,2015-5-22,for piezo EINT debounce setting end*/
