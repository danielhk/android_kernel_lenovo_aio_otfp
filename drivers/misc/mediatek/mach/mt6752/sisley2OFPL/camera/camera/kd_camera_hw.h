...
// modiby by yfx for test lenovo proj
#define SUPPORT_I2C_BUS_NUM2        I2C_CAMERA_MAIN_CHANNEL
//#define SUPPORT_I2C_BUS_NUM2        I2C_CAMERA_MAIN_CHANNEL

#define SUPPORT_I2C_BUS_NUM3        I2C_CAMERA_SUB_CHANNEL

#define GPIO_MIPI_SWITCH_EN			(GPIO61 | 0x80000000) 
#define GPIO_MIPI_SWITCH_SEL		(GPIO62 | 0x80000000) 
#define CAMERA_MCLK2				(GPIO31 | 0x80000000) 
#define GPIO_CAMERA_MAIN2_PDN		(GPIO32 | 0x80000000) 
#define GPIO_CAMERA_MAIN_PDN		(GPIO33 | 0x80000000) 
#define GPIO_CAMERA_SUB_PDN			(GPIO34 | 0x80000000) 
#define GPIO_CAMERA_SUB_DVDD		(GPIO118 | 0x80000000) 
#define GPIO_CAMERA_MAIN_DVDD		(GPIO121| 0x80000000) 
#define GPIO_CAMERA_MAIN2_DVDD		(GPIO115 | 0x80000000) 
// end
#define CAMERA_MCLK1				(GPIO30 | 0x80000000) 
