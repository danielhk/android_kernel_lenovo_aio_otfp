...
{
	unsigned int val = get_devinfo_with_index(28) & 0xFF000000;	/*[31:24]*/
...
{
	unsigned int val = get_devinfo_with_index(28) & 0x00FFC000;	/*[23:14]*/
...
{
	unsigned int val = get_devinfo_with_index(28) & 0x00003FFF;	/*[13:0]*/
...
{
	unsigned int val = get_devinfo_with_index(29) & 0x00000007;	/*[2:0]*/
