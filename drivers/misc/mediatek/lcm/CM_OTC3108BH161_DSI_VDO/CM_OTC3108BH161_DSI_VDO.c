...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.vertical_backporch					= 4; //6; //4; //6; //10;
		params->dsi.vertical_frontporch					= 4;//6; //4//6; //10;
		params->dsi.vertical_active_line				= FRAME_HEIGHT; 

		params->dsi.horizontal_sync_active				= 40; //40; //44; //(120-40-40); //1;
		params->dsi.horizontal_backporch				= 40;//44; //40; //44; //57;
		params->dsi.horizontal_frontporch				= 40;//44; //40; //44; //32;
...
LCM_DRIVER cm_otc3108bhv161_dsi_vdo_lcm_drv = 
{
    .name			= "CM_OTC3108bh161_DSI_VDO",
