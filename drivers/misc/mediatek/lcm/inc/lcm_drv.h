...
//lenovo-sw wuwl10 add 20141224 for esd recover panel backlight begin
        void (*esd_recover_backlight)(void);
//lenovo-sw wuwl10 add 20141224 for esd recover panel backlight end
	...
	////lenovo add begin by jixu@lenovo.com
		...
		void (*set_cabcmode_cmd)(void* handle,unsigned int mode);
    ...
    void (*set_sremode)(void* handle,unsigned int mode);
    void (*set_sremode_video)(unsigned int mode);
#endif
} LCM_DRIVER;
