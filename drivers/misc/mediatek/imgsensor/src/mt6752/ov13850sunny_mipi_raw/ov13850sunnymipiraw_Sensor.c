...
#include "ov13850sunnymipiraw_Sensor.h"

#ifdef CONFIG_COMPAT
#include <linux/compat.h>
#endif
/****************************Modify Following Strings for Debug****************************/
#define PFX "OV13850SUNNY_camera_sensor"
#define LOG_1 LOG_INF("OV13850SUNNY,MIPI 4LANE\n")
...
//sensor otp
extern int ov13850sunnyr2a_update_eeprom();
extern bool ov13850sunny_otp_check_mid(void);

static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV13850SUNNY_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    LOG_INF("ov13850sunny get_imgsensor_id start\n");
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                check_mid=ov13850sunny_otp_check_mid();
                if (!check_mid)
                {
                  *sensor_id = 0xFFFFFFFF;
                  LOG_INF("get_imgsensor_id, MID != 0x01(sunny) \n");
...
UINT32 OV13850SUNNY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    ...
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    OV13850SUNNY_MIPI_RAW_SensorInit    */
