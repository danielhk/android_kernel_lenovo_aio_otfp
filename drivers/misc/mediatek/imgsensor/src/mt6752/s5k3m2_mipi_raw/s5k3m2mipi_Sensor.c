...
//MIPI 600Mbps/lane
//modified 0x4000_030E 0x6A=>0x32
	write_cmos_sensor(0x6028,0x2000);
	write_cmos_sensor(0x602A,0x14F0);
	write_cmos_sensor(0x6F12,0x0040);
	write_cmos_sensor(0x6F12,0x0040);
...
static void pip_capture_setting()
{
	...
	write_cmos_sensor(0x0344,0x000C);
	write_cmos_sensor(0x0346,0x000C);
	write_cmos_sensor(0x0348,0x1073);  //MirrorFlip case:6F for bpc off, 73 for bpc on
	write_cmos_sensor(0x034A,0x0C33);  //MirrorFlip case:2F for bpc off, 33 for bpc on
	write_cmos_sensor(0x034C,0x1060);
	write_cmos_sensor(0x034E,0x0C20);
	write_cmos_sensor_8(0x0901,0x11);
	write_cmos_sensor(0x0380,0x0001);
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
			LOG_INF("SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY scenarioId:%d, ret param p: %p\n", *feature_data, feature_data+1);
