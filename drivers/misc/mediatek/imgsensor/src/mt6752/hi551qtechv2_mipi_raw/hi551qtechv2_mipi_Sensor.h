 ...
 *
 ****************************************************************************/
#ifndef _HI551QTECHV2_MIPI_SENSOR_H
#define _HI551QTECHV2_MIPI_SENSOR_H
...
//version 2
#define LSC_LENGTH  453
#define MODULE_V2_LENGTH 27
#define OTPV2_MODULE_GROUP_ONE       0x1802
#define OTPV2_MODULE_GROUP_TWO      0x1A14
#define OTPV2_MODULE_GROUP_THREE   0x1C23
#define OTPV2_AWB_FLAG_ADDR       0x181D
#define OTPV2_AWB_GROUP_ONE      0x181E
#define OTPV2_AWB_GROUP_TWO     0x1A2F
#define OTPV2_AWB_GROUP_THREE  0x1C3E
#define OTPV2_LSC_FLAG_ADDR       0x183B
#define OTPV2_LSC_GROUP_ONE      0x183C
#define OTPV2_LSC_GROUP_TWO     0x1A4C
#define OTPV2_LSC_GROUP_THREE  0x1C5B
...
typedef struct 
{
    ...
    kal_uint8 product_month;
    kal_uint8 product_day;
    kal_uint8 product_line;
    kal_uint8 otp_calibration_version_vendor;
    kal_uint8 sensor_id;
    kal_uint8 lens_id;
    kal_uint8 vcm_id;
    kal_uint8 driver_ic_id;
...
typedef struct 
{
	...
	int group;
	union {
		kal_uint8 module_data[MODULE_V2_LENGTH];
		module_data_info info;
        module_data_info_v2 info_v2;
	} data;
} module_info;
...
extern void HI551QTECHV2_OTP_ApplyWB(bool apply);
extern int HI551QTECHV2OTP_OTP_Check(void);
extern bool isHI551QTECHV2haveOTP(void);
extern int HI551QTECHV2_OTP_Ver_Check(void);
#endif 
