...
/*Begin, lenovo-sw chailu1 add 45-50  CV limit fuction,  20150318 */
#ifdef LENOVO_TEMP_POS_45_TO_POS_50_CV_LiMIT_SUPPORT
extern kal_bool lenovo_battery_is_temp_45_to_pos_50();
#endif
/*End, lenovo-sw chailu1 add 45-50  CV limit fuction,  20150318 */
 // ============================================================ //
 //define
 // ============================================================ //
#define STATUS_OK	0
 ...
 kal_uint32 charging_parameter_to_value(const kal_uint32 *parameter, const kal_uint32 array_size, const kal_uint32 val)
{
 ...
 /*Begin lenovo-sw chailu1 poring for charging terminate as 0.1c */
 ...
 void lenovo_charging_again_enble(void)
{
	...
	bq24296_set_chg_config(0x0); // charger enable
	msleep(10);
...
#endif
 /*End lenovo-sw chailu1 poring for charging terminate as 0.1c */
...
//    upmu_set_rg_bc11_rst(1);        //BC11_RST
    ...
    bq24296_set_en_hiz(0x0);
/*start Lenovo sw chailu1 add supprot 4.4v battery*/
#if defined(HIGH_BATTERY_VOLTAGE_4400MV_SUPPORT)
    bq24296_set_vindpm(0x8); //VIN DPM check 4.52V ,TI recomand
#else
 ...
 /*End, lenovo-sw chailu1 add 45-50  CV limit fuction,  20150318 */
    ...
    bq24296_set_vreg(0x38); // lenovo-sw chailu1 change cv to 4.4v 
#else
 ...
 static kal_uint32 charging_set_cv_voltage(void *data)
 {
	...
	set_cv_value = bmt_find_closest_level(VBAT_CV_VTH, array_size, cv_value);
	register_value = charging_parameter_to_value(VBAT_CV_VTH,array_size, set_cv_value);
