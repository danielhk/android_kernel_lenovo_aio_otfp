...
*
********************************************************************************/
#define CAM_CAL_DRVNAME "HI551_CAM_CAL_DRV"
...
inline static int RegisterCAM_CALCharDrv(void)
{
    ...
    CAM_CAL_class = class_create(THIS_MODULE, "HI551_CAM_CALdrv");
...
static void __exit HI551_CAM_CAL_i2C_exit(void)
{
//	platform_driver_unregister(&g_stCAM_CAL_Driver);
}

module_init(HI551_CAM_CAL_i2C_init);
module_exit(HI551_CAM_CAL_i2C_exit);

MODULE_DESCRIPTION("HI551 CAM_CAL driver");
