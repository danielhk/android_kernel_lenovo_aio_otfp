		...
		unsigned short addr, unsigned char *data, unsigned short length)
{
	...
	read_msg[0].len = 1;
	read_msg[0].buf = &buf;
	read_msg[0].timing = 380;//scl speed 400->380 for tLow;SCL
	...
	for (ii = 1; ii <= total; ii++) {
		...
		read_msg[ii].timing = 380;//scl speed 400->380 for tLow;SCL
	}
	...
	struct i2c_msg msg[] = {
		{
			...
			.timing = 380,//scl speed 400->380 for tLow;SCL
		}
	};
...
static struct tpd_driver_t synaptics_rmi4_driver = {
	...
	.suspend = synaptics_rmi4_suspend,
	.resume = synaptics_rmi4_resume,
#ifndef TPD_HAVE_BUTTON //add for read version
	.tpd_have_button = 1,
#else
	.tpd_have_button = 0,
#endif
